...
class JSON
{
   template<typename T>
   class StraightMap{
      vector<std::pair<string, T>> values;

   public:
      using iterator = typename vector<std::pair<string, T>>::iterator;
      using const_iterator = typename vector<std::pair<string, T>>::const_iterator;

      StraightMap(){}
      StraightMap(decltype(values.begin()) b, decltype(values.end()) e) : values(b, e){}
    ...
    public:
        ...
        JSON( const JSON &other ) {
            ...
            case Class::Object:
                Internal.Map = 
                    new StraightMap<JSON>( other.Internal.Map->begin(),
        ...
        JSONWrapper<StraightMap<JSON>> ObjectRange() {
            if( Type == Class::Object )
                return JSONWrapper<StraightMap<JSON>>( Internal.Map );
            return JSONWrapper<StraightMap<JSON>>( nullptr );
        }
        ...
        JSONConstWrapper<StraightMap<JSON>> ObjectRange() const {
            if( Type == Class::Object )
                return JSONConstWrapper<StraightMap<JSON>>( Internal.Map );
            return JSONConstWrapper<StraightMap<JSON>>( nullptr );
        }
    ...
    private:
        void SetType( Class type ) {
            ...
            case Class::Object:    Internal.Map    = new StraightMap<JSON>(); break;
